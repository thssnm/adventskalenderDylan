export const numbers = [
  ...
  { number: "12", title: "title", text: "" },
  {
    number: "1",
    title: "title",
    text: `Herzlich willkommen zum diesjährigen Adventskalender. Ich bin sehr froh dich dabei zu haben und möchte dich in den nächsten 24 Tagen auf eine Reise voller spannender Kaffees, Erfahrungen und neuem Wissen mitnehmen.

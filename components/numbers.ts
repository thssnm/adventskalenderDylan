...
Im Shop haben wir ihn als helle und dunkle Röstung, um alle Brühmethoden abzudecken.<BR><BR>`,
  },
  {
    number: "1",
    title: "title",
    text: `Es ist soweit, wir starten in eine neue sensorische Reise, die den Fokus auf Kaffeevielfalt aber vor Allem auf das Vergnügen mit unserem Lieblingsgetränk legt.<BR>
Dieses Jahr haben wir unsere Kapazität in allen Belangen auf die Probe gestellt.<BR>
Nicht nur, dass wir mit dem 5. Adventskalender zwei Versionen haben und somit über 30 verschiedene Kaffees rösten mussten, sondern auch nach über zweitausend kleinen Tütchen, die alle per Hand verpackt wurden, kamen immer neue Interessenten dazu, sodass wir erst gestern um 16 Uhr tatsächlich dieses Projekt beendet haben..<BR>
Nicht ganz, denn für mich beginnt jetzt der zweite Spaß! ;-)<BR><BR>

In den kommenden Tagen werdet ihr hier Tag für Tag einen handgeschriebenen Text lesen können, kein ChatGPT, kein Copy Paste - ich hoffe, dass ich euch auch in diesem Jahr auf eine Reise mitnehmen kann und euch viel aus meiner Welt als Coffeologe und mittlerweile elf Jahren als Kaffeeröster zeigen, Gedanken und Erfahrungen teilen, sowie mit Zukunftsperspektiven überraschen kann.<BR>
Wir blicken auf über 500 Jahre des Kaffeekonsums zurück, aber haben erst in den letzten Jahrzehnten vermutlich die 90% des heutigen relevanten Wissens erlangt.<BR>
Für Fragen stehe ich jederzeit per Mail, auf unserem Social Media oder persönlich im Geschäft (Google Öffnungszeiten sind immer aktuell) zur Verfügung.<BR>
Über Feedback freue ich mich in jedem Fall, bitte aber um Verständnis, dass ich neben dem Tagesgeschäft an unserer Kafferbar, in der Rösterei, Kursen und der Betreuung unserer Geschäftskunden, sowie Caterings, Vorträgen und Schlaf, für eine Rückmeldung ungefähr eine Woche benötige.<BR>
Deshalb wünsche ich erstmal einen schönen ersten Advent und für alle, die neu dabei sind oder beschenkt wurden:<BR>
ich bin Duje Dadic, Kaffeeröster von Dylan & Harper und für die kommenden 24 Tage eures Kaffeeerlebnisses zuständig :)<BR><BR>

PS. Die digitalen Türchen beziehen sich ausschließlich auf die klassische Version des Kalenders.<BR>
Für zwei Versionen jeden Tag zu schreiben wäre einfach nicht machbar, da wir unter anderem ab der zweiten Dezemberwoche bis zum 23.12. täglich geöffnet haben.<BR>
Individuelle Fragen zu den exklusiven Türchen, bitte individuell handhaben ;)

<BR><BR><BR>

1.<BR>
Heute starten wir mit einem Kaffee, der bereits letztes Jahr in den Kalender kommen sollte. Allerdings hatten wir so viele grandiose Kaffees, sodass es einfach keinen Platz gab.<BR>
Besonders in den letzten Jahren hat die Varietät Castillo viel an Bekanntheit gewonnen. Der Anbau erfolgt in Kolumbien, deshalb ist ein Castillo außerhalb kaum zu finden.<BR>
Wir haben wie so oft das Glück, dass unsere Kaffeebauern selbst daran interessiert sind Vielfalt und Fortschritt auf ihren Farmen zu haben.<BR>
Andres Quintanilla Bellucci ist nicht nur ein weit entfernter Cousin der italienischen Schönheit, er hat mit seinem Agrar-Abschluss eine super Voraussetzung für die Zukunft.<BR>
Als unser jüngster Farmer hat er die zwei Plantagen, die seit der Oma Amalia nicht mehr beachtet wurden, übernommen.<BR>
Sein Vater und Geschwister sind alle Juristen und folgen dem Pfad des Opas, der damals als erster Staatsanwalt El Salvadors im Bürgerkrieg ermordet wurde.<BR>
Obwohl sein Vater bereits Vize-Präsident war und im Büro voller Stolz das Foto mit Helmut Kohl hängt, möchte Andres als Kaffeebauer seine Familie und das Land unterstützen.<BR>
Aufgrund seines perfekten Englisch und ein wenig Latino-Crazyness verstehen wir uns sehr gut. Aktuell dauert es meist zwei Wochen für eine Antwort, da er frisch verheiratet ist ;-)<BR><BR>

Der Castillo wurde, für El Salvador unüblich, als Natural verarbeitet und von mir relativ hell geröstet.<BR>
Als Espresso kommt eine schöne balancierte Frucht in die Tasse, bei gutem Körper und leichter Bitterkeit.<BR>
Als Filter muss ich gestehen habe ich diese Röstung noch nicht probiert, deshalb orientiere ich mich an meinem letzten Eindruck im Frühjahr mit ebenfalls gutem Körper, Pfläumchen und etwas Mandelblüte.<BR>
Leider kann Andres momentan keine Naturals machen, da das Risiko zu hoch wäre, bei Regen und der Luftfeuchtigkeit die Ernte während der Trocknung zu verlieren.<BR>
Wir haben also nur noch die paar Kilogramm von der Adventskalender Röstung auf Anfrage und werden kein offizielles Produkt daraus machen.
<BR><BR>`,
  },
  {
    number: "9",
...
Dann gibt es sinnvollen Cascara, wie diesen. Hier sind die Kirschen nur von einer Varietät (Catuai).<BR> Ihr habt uns jetzt etwas kennen gelernt, wir sind einfach immer auf der Suche nach dem übernächsten Level, nach höchster Transparenz, nach besten Verpackungen, wir machen in keinem Schritt der Wertschöpfung Kompromisse.<BR>
Natürlich könnte man jetzt sagen: „Toll, neues Produkt, jetzt müssen erstmal 5mio Menschen Cascara kennen lernen!" und ja, das stimmt auch. Dafür sind aber dann die anderen zuständig. Es gibt einen Cascara-Secco hier aus der Region, der sogar von der Höhle der Löwen (TV Format mit Investoren für Startups), dann haben wir von unseren Freunden aus Waiblingen die „Kasoda" Kaffeekirschlimo immer an der Bar vorrätig und noch weitere Produkte.<BR>
